...
return [
    ...
    */
    ...
    'confirmed' => 'Значение поля не совпадает',
    ...
    'max' => [
        'numeric' => 'Должно быть не больше :max',
        'file' => 'The :attribute may not be greater than :max kilobytes.',
        'string' => 'Должно быть не больше :max символов',
    ...
    'min' => [
        ...
        'string' => 'Значение поля должно быть не меньше :min символов',
